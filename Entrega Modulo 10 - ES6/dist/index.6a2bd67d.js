...
})({"fZmbD":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ef776e7f6a2bd67d";
"use strict";
...
},{}],"eYZRs":[function(require,module,exports) {
var _buttonsJs = require("./buttons.js");
_buttonsJs.loadCharacters();
_buttonsJs.loadLocations();
_buttonsJs.loadEpisodes();

},{"./buttons.js":"34F68"}],"34F68":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadCharacters", ()=>loadCharacters);
parcelHelpers.export(exports, "loadLocations", ()=>loadLocations);
parcelHelpers.export(exports, "loadEpisodes", ()=>loadEpisodes);
var _utilsJs = require("./utils.js");
var _dataBusinessJs = require("./data-business.js");
function loadCharacters() {
    document.getElementById("characters").addEventListener("click", function() {
        _dataBusinessJs.getCharacters().then((data)=>{
            ...
            for (let character of characters){
                ...
                node.addEventListener("click", function() {
                    _dataBusinessJs.getCharacterDetail(character.id).then((data)=>{
                        const singleCharacter = data;
                        _utilsJs.showCharacter(singleCharacter);
                    });
                });
                nodes.push(node);
            }
...
function loadLocations() {
    document.getElementById("locations").addEventListener("click", function() {
        ...
        _dataBusinessJs.getLocation().then((data)=>{
            const locations = data.results;
            const nodes = [];
            document.getElementById("root").innerHTML = "";
            for (const location of locations){
                let node = _utilsJs.createLocationRow(location);
                nodes.push(node);
            }
            for (let node1 of nodes)document.getElementById("root").append(node1);
        });
...
function loadEpisodes() {
    document.getElementById("episodes").addEventListener("click", function() {
        document.getElementById("character-detail").innerHTML = "";
        _dataBusinessJs.getEpisodes().then((data)=>{
            const episodes = data.results;
            const nodes = [];
            document.getElementById("root").innerHTML = "";
            for (const episode of episodes){
                let node = _utilsJs.createEpisodeRow(episode);
                nodes.push(node);
            }
            for (let node1 of nodes)document.getElementById("root").append(node1);
        });
...
},{"./utils.js":"9nHTb","./data-business.js":"eUQ2o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9nHTb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./styles.css":"dc17r","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dc17r":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{}],"eUQ2o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function getCharacterDetail(characterId) {
    return fetch(`https://rickandmortyapi.com/api/character/${characterId}`).then((response)=>{
        if (response.ok) return response.json();
        else console.log(response.statusText);
    });
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fZmbD","eYZRs"], "eYZRs", "parcelRequirec838")

//# sourceMappingURL=index.6a2bd67d.js.map
