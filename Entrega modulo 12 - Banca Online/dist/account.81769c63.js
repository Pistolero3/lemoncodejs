...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/account/account.mapper.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"pages/account/account.js":[function(require,module,exports) {
"use strict";

var _element = require("../../common/helpers/element.helpers");
var _account = require("./account.validations");
var _router = require("../../core/router");
var _account2 = require("./account.mapper");
...
if (isEditMode) {
  (0, _account3.getAccount)(params.id).then(function (apiAccount) {
    ...
    (0, _element.onSetValues)(account);
  });
}
var account = {
  id: '',
...
(0, _element.onUpdateField)('type', function (event) {
  ...
  _account.formValidation.validateField('type', account.type).then(function (result) {
    (0, _element.onSetError)('type', result);
  });
});
(0, _element.onUpdateField)('alias', function (event) {
  var value = event.target.value;
  account = _objectSpread(_objectSpread({}, account), {}, {
    alias: value
  });
  _account.formValidation.validateField('alias', account.alias).then(function (result) {
    (0, _element.onSetError)('alias', result);
  });
});
var onSave = function onSave() {
  var apiAccount = (0, _account2.mapAccountFromViewModelToApi)(account);
...
},{"../../common/helpers/element.helpers":"common/helpers/element.helpers.js","./account.validations":"pages/account/account.validations.js","../../core/router":"core/router/index.js","./account.mapper":"pages/account/account.mapper.js","./account.api":"pages/account/account.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
