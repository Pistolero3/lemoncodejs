...
var url2 = "".concat("http://localhost:3000/api", "/account");
...
var getAccount = function getAccount(id) {
  return _axios.default.get("".concat(url2, "/").concat(id)).then(function (response) {
    return response.data;
  });
};
...
exports.mapAllMovementsFromApiToVm = exports.mapAccountFromApiToVm = void 0;
...
var mapAllMovementsFromApiToVm = function mapAllMovementsFromApiToVm(movements) {
  return movements.map(function (movement) {
    return mapMovementFromApiToVm(movement);
  });
};
exports.mapAllMovementsFromApiToVm = mapAllMovementsFromApiToVm;
var mapMovementFromApiToVm = function mapMovementFromApiToVm(movement) {
...
var isAccountChosen = Boolean(params.id);
if (isAccountChosen) {
  (0, _movements.getAccount)(params.id).then(function (apiAccount) {
    var account = (0, _movements2.mapAccountFromApiToVm)(apiAccount);
    (0, _helpers.onSetValues)(account);
    (0, _movements.getMovements)(params.id).then(function (movements) {
      var viewModelMovements = (0, _movements2.mapAllMovementsFromApiToVm)(movements);
      (0, _movements3.addMovementRows)(viewModelMovements);
    });
  });
} else {
  alert('Por favor, vuelva a Mis Cuentas y navegue a través de la opción Movimientos');
}
},{"./movements.api":"pages/movements/movements.api.js","./movements.mappers":"pages/movements/movements.mappers.js","./movements.helpers":"pages/movements/movements.helpers.js","../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
