...
exports.sendTransfer = exports.getAccount = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/account");
var url2 = "".concat("http://localhost:3000/api", "/transfer");
...
var sendTransfer = function sendTransfer(transfer) {
  return _axios.default.post(url2, transfer).then(function (response) {
    return response.data;
  });
};
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/transfer/transfer.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapTransferFromVmToApi = void 0;
var mapTransferFromVmToApi = function mapTransferFromVmToApi(transfer) {
  return transfer = {
    iban: transfer.iban.replace(/(\w{4})(\B)/g, '$1 '),
    name: transfer.name,
    amount: Number(transfer.amount),
    date: "".concat(transfer.day, "/").concat(transfer.month, "/").concat(transfer.year),
    concept: transfer.concept,
    notes: transfer.notes,
    email: transfer.email
  };
};
exports.mapTransferFromVmToApi = mapTransferFromVmToApi;
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
//! version : 2.29.4
...
var dayValidator = function dayValidator(_ref) {
  ...
  var validatedDate = Number(value);
  var succeeded = validatedDate > 0 && validatedDate <= 31;
  return {
    succeeded: succeeded,
...
var monthValidator = function monthValidator(_ref2) {
  var value = _ref2.value;
  var validatedDate = Number(value);
  var succeeded = validatedDate > 0 && validatedDate <= 12;
  return {
    succeeded: succeeded,
...
var isValidDateValidator = function isValidDateValidator(_ref3) {
  var value = _ref3.value;
  var succeeded = (0, _moment.default)(value, 'YYYY-MM-DD').isValid();
  return {
    succeeded: succeeded,
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-is-number-validator":"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js","@lemoncode/fonk-min-number-validator":"../node_modules/@lemoncode/fonk-min-number-validator/dist/@lemoncode/fonk-min-number-validator.esm.js","@lemoncode/fonk-later-date-validator":"../node_modules/@lemoncode/fonk-later-date-validator/dist/@lemoncode/fonk-later-date-validator.esm.js","moment/moment":"../node_modules/moment/moment.js"}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";
...
var _transfer4 = require("./transfer.validations");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var param = _router.history.getParams();
var transferDate = {
  year: '',
  month: '',
  day: ''
...
(0, _transfer.getAccount)().then(function (accounts) {
  return (0, _transfer3.setAccountOptions)(accounts, param.id);
});
...
(0, _helpers.onUpdateField)('amount', function (event) {
  ...
  _transfer4.formValidation.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('concept', function (event) {
  ...
  _transfer4.formValidation.validateField('concept', transfer.concept).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _transfer4.formValidation.validateField('notes', transfer.notes).then(function (result) {
    (0, _helpers.onSetError)('notes', result);
  });
});
(0, _helpers.onUpdateField)('day', function (event) {
  var value = event.target.value;
  transferDate = _objectSpread(_objectSpread({}, transferDate), {}, {
    day: value
  });
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    day: value,
...
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer4.formValidation.validateForm(transfer).then(function (result) {
    ...
    if (result.succeeded) {
      var transferApi = (0, _transfer2.mapTransferFromVmToApi)(transfer);
      console.log(transferApi);
      (0, _transfer.sendTransfer)(transferApi);
    }
  });
});
},{"./transfer.api":"pages/transfer/transfer.api.js","../../core/router":"core/router/index.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
