...
})({"8D2oX":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f957fbcb1ae12589";
"use strict";
...
},{}],"3fJa9":[function(require,module,exports) {
...
class Reservas {
    ...
    calcularSubtotal = ()=>{
        this._reservas.reduce((acc, { noches  })=>this._subtotal = acc + noches * 100, 0);
        this._subtotal = this._subtotal + this.calculatePoeple() + this.calculateBreakfast();
    ...
    calculateBreakfast = ()=>{
        let breakfast = 0;
        this._reservas.map(({ desayuno , pax , noches  })=>desayuno === true ? breakfast += 15 * pax * noches : breakfast);
        return breakfast;
    };
    calculatePoeple = ()=>{
        let peoplePayment = 0;
        this._reservas.map(({ pax , noches  })=>peoplePayment += (pax - 1) * noches);
...
class reservaParticular extends Reservas {
    ...
    calcularSubtotal = ()=>{
        this._reservas.reduce((acc, { noches , tipoHabitacion  })=>this._subtotal = acc + noches * this.roomType(tipoHabitacion), 0);
        this._subtotal = this._subtotal + this.calculatePoeple() + this.calculateBreakfast();
        return this._subtotal;
    };
...
},{}]},["8D2oX","3fJa9"], "3fJa9", "parcelRequirec838")

//# sourceMappingURL=index.1ae12589.js.map
