...
})({"1y2yu":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "328530769accff02";
"use strict";
...
},{}],"4Tu9U":[function(require,module,exports) {
...
console.log("************** concat ********************");
const concat = (...strings)=>strings.reduce((acc, string)=>{
        acc += " | " + string;
        return acc;
    });
...
const calcMult = (...numbers)=>numbers.reduce((acc, number)=>{
        acc = acc * number;
        return acc;
    });
...
const firstEqual = (x, ...strings)=>strings.every((string)=>string.startsWith(x) ? true : false);
...
console.log("************** shout ********************");
const shout = (...words)=>{
    return words.map((word)=>"\xa1" + word.toUpperCase() + "!").join("");
};
...
const calcSubtotal = (lists, category)=>{
    let subtotal = 0;
    lists.filter((list)=>list.category === category).map((list)=>subtotal += list.price * list.units);
    return `El subtotal para la categoria ${category} es ${subtotal}`;
};
console.log(calcSubtotal(shoppingCart, "Droguer\xeda"));
console.log("******** SHOPPING LIST por Consola **************");
const consoleList = (lists)=>{
    return lists.sort((a, b)=>a.category < b.category ? -1 : a.category > b.category ? 1 : 0).forEach(({ product , price , units  })=>console.log(`${product} -> ${price * units} Euros`));
};
consoleList(shoppingCart);

},{}]},["1y2yu","4Tu9U"], "4Tu9U", "parcelRequirec838")

//# sourceMappingURL=index.9accff02.js.map
